...
const Register = (props) => {
    ...
    return (
        <>
            ...
            <p className='text-white px-5 text-center'>Create your Account In Amo Tasks</p>
            <form onSubmit={handleSubmit} className='flex flex-col gap-4 justify-center items-center mt-3'>
                ...
                <button type="submit" disabled={process} className='bg-white disabled:opacity-10  w-[20vw] py-2 rounded-md text-black font-bold'> {process ? <div role="status" className='flex justify-center items-center'>
    ...
    <span class="sr-only">Loading...</span>
            ...
            <a className="redirecttologin m-auto underline text-white text-center cursor-pointer pt-3 flex hover:text-[#000]" onClick={() => props.setEntrystate(false)}>Already Registered? Then Login</a>
