    ...
    return (
        <>
            <div className="tasksforms flex flex-col gap-2 justify-center items-center w-full">
                ...
                <label htmlFor="task_title" className='dark:text-white bg-transparent border border-2 border-gray-200 rounded-md p-2 w-2/5'>
                    <input type="text"
                ...
                <select name="task_cat" id="task_cat" value={props.taskCat} placeholder="Select Category" className="bg-transparent dark:text-white border border-2 border-gray-200 rounded-md p-2 w-2/5" onChange={(e) => props.settaskCat(e.target.value)}>
                ...
                <select name="task_status" id="task_status" value={props.taskStatus} placeholder="Select Status" className="dark:text-white bg-transparent border border-2 border-gray-200 rounded-md p-2 w-2/5" onChange={(e) => props.settaskStatus(e.target.value)}>
                ...
                <textarea name="task_desc" id='task_desc' placeholder='Enter Task Description' className='bg-transparent h-44 dark:text-white border border-2 border-gray-200 rounded-md p-2 w-2/5' value={props.taskdesc} onChange={(e) => props.settaskdesc(e.target.value)}>
                </textarea>

                <div className="button w-2/5 flex flex-col justify-start items-start">
                    ...
                    <button
                        ...
                        type='button'
                        className='bg-[#3763d2] dark:bg-white dark:text-black text-white border border-2 border-gray-200 rounded-md p-2 w-2/5'
                    >
